...
impl HighScores {
    ...
    pub fn personal_top_three(&self) -> Vec<u32> {
        let mut heap = BinaryHeap::from(self.scores.clone());
...
// Another implementation based on slices.
// HighScores is a view on scores array (borrows).
// So scores cannot be modified.
// Advantage: no Vec allocations neither copied values.
//
// #[derive(Debug)]
...
//
//     pub fn personal_top_three(&self) -> Vec<u32> {
//         // Copie minimale : seulement pour trier
